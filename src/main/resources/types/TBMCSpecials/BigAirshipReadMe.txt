...
The next smallest Airship is the Airship.
The next largest Airship is the MegaAirship.

The BigAirship is the penultimate model of all "Flying Only" craft.
...
To register the craft, there must be a sign with BigAirship in the first line. Right clicking the sign will trigger the registration script to check the composition of the build.
...
Using a stick, this craft's speed is .75 M/Second.
While cruising, this craft's speed is .35(5+1M)/second or 2.1M/Second.

This craft's furnaces must have fuel to move, and will burn that fuel at a rating of 4.0. Coal blocks last longer than Coal.
...
At least 2.0% of the total blocks are Redstone Blocks for the engines.
